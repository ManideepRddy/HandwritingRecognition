...
class trainer:
    ...
    def CVDispProcessing(self, analysis):
    ...
    def Pretrainer(inFile, outFile):
        listdir = os.listdir(inFile)
        subscription_key = "8e92fb22de3043bfba7e8ff2622b6ca7"
        endpoint = "https://manideep.cognitiveservices.azure.com/"
        ...
        for file in listdir:
            ...
            with open(outFile+"/"+str(c)+".txt",'w') as f:        
                for i in range(len(lines)):            
                    f.write(lines[i]["text"] + "\n")  
